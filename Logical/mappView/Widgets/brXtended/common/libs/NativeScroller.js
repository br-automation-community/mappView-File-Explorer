...
define([
    'brease'
], function ({ core: { Class: SuperClass } }) {
    
    /** 
     * @class widgets.brXtended.common.libs.NativeScroller
    ...
    p._stop = function (e) {
        ...
        if (isNotInitiated.call(this, e.type)) {
            return;
        }
        ...
        if (animationNeeded.call(this, duration)) {
        ...
        if (newX !== this.x || newY !== this.y) {
            ...
            if (isOutOfBoundaries.call(this, newX, newY)) {
    ...
    function isOutOfBoundaries(newX, newY) {
        return newX > 0 || newX < this.maxScrollX || newY > 0 || newY < this.maxScrollY;
    }

    function isNotInitiated(eventType) {
        return !this.internal.enabled || this.internal.eventType[eventType] !== this.initiated;
    }

    function animationNeeded(duration) {
        return this.internal.momentum && duration < 300;
    }
