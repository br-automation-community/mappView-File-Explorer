...
define([
    ...
    /**
     * @class  widgets.brXtended.common.libs.BoxLayout
     ...
     *           e.g.:  
     *               define(['widgets/brXtended/common/libs/BoxLayout'], function(BoxLayout){...});  
    ...
    const boxContainerNode = document.createElement('DIV');
    boxContainerNode.classList.add(BoxLayout.CONTAINER_CLASS);
    const boxNode = document.createElement('DIV');
    boxNode.classList.add(BoxLayout.BOX_CLASS);
    /**
     * @method
    ...
    BoxLayout.createBoxContainer = function () {
        return boxContainerNode.cloneNode();
    };
