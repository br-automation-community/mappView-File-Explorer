...
define(['brease',
    ...
    'widgets/brXtended/common/libs/redux/utils/UtilsDataHandler'
], function ({ callWidget }, DataHandlerActions, UtilsDataHandler) {
   
    /**
     * @class widgets.brXtended.common.libs.redux.reducers.DataHandler.DataHandlerReducer
     * 
        ...
        switch (action.type) {
            ...
            case DataHandlerActions.CHILD_ADDED:
                if (action.event.target === action.widget.elem) {
                    ...
                    childrenWidget = callWidget(childrenWidgetId, 'widget');
