'use strict';
define(['brease',
    'widgets/brXtended/common/libs/redux/utils/UtilsJSON'
], function ({ controller: { uiController } }, UtilsJSON) {

    /**
     * @class widgets.brXtended.common.libs.ReorderingByJson
    ...
    ReorderingByJson.getOrder = function getOrder(container) {
        ...
        for (var i = 0; i < elements.length; i += 1) {
            widget = uiController.callWidget(elements[i].id, 'widget');
